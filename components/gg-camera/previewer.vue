<template>
  <wxml-to-canvas v-if="canvasWidth && canvasHeight" class="previewCanvas" :width="canvasWidth" :height="canvasHeight"></wxml-to-canvas>
</template>

<script>
  import waterMarkProvider from './watermark/index.js';
  // import wxmlToCanvas from '@/components/wxcomponents/wxml-to-canvas/index.vue'
