...
Component({
  ...
  methods: {
    async renderToCanvas(args) {
      ...
      if (!ctx || !canvas) {
        throw new Error('renderToCanvas: fail canvas has not been created');
      }
    ...
    canvasToTempFilePath(args = {}) {
      return new Promise((resolve, reject) => {
        ...
        wx.canvasToTempFilePath({
          ...
          width,
          height,
          destWidth: (width * (args.dpr || this.dpr || 1)),
          destHeight: (height * (args.dpr || this.dpr || 1)),
          canvas: this.canvas,
